 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.units.convert = (function day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$convert(p__25676,right){
...
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25677__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25677__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var vec__25708 = temp__5735__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25708,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25708,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25708,(2),null);
...
var map__25721 = u(x);
var map__25721__$1 = (((((!((map__25721 == null))))?(((((map__25721.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__25721.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__25721):map__25721);
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25721__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__25722 = u(y);
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25722__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 + m2));
});
...
while (G__25873__i < G__25873__a.length) {G__25873__a[G__25873__i] = arguments[G__25873__i + 2]; ++G__25873__i;}
  more = new cljs.core.IndexedSeq(G__25873__a,0,null);
} 
...
var G__25876 = null;
if (arguments.length > 2) {
var G__25877__i = 0, G__25877__a = new Array(arguments.length -  2);
while (G__25877__i < G__25877__a.length) {G__25877__a[G__25877__i] = arguments[G__25877__i + 2]; ++G__25877__i;}
G__25876 = new cljs.core.IndexedSeq(G__25877__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__25876);
}
...
var map__25740 = u(x);
var map__25740__$1 = (((((!((map__25740 == null))))?(((((map__25740.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__25740.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__25740):map__25740);
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25740__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__25741 = u(y);
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25741__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 - m2));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3 = (function() { 
var G__25881__delegate = function (x,y,more){
...
var G__25881 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
...
while (G__25882__i < G__25882__a.length) {G__25882__a[G__25882__i] = arguments[G__25882__i + 2]; ++G__25882__i;}
  more = new cljs.core.IndexedSeq(G__25882__a,0,null);
} 
return G__25881__delegate.call(this,x,y,more);};
...
return G__25881__delegate(x,y,more);
});
...
var G__25885 = null;
if (arguments.length > 2) {
var G__25886__i = 0, G__25886__a = new Array(arguments.length -  2);
while (G__25886__i < G__25886__a.length) {G__25886__a[G__25886__i] = arguments[G__25886__i + 2]; ++G__25886__i;}
G__25885 = new cljs.core.IndexedSeq(G__25886__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__25885);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25760__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__25761 = u(y);
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25761__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
...
var G__25890__delegate = function (x,y,more){
...
var G__25890 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__25891__i = 0, G__25891__a = new Array(arguments.length -  2);
while (G__25891__i < G__25891__a.length) {G__25891__a[G__25891__i] = arguments[G__25891__i + 2]; ++G__25891__i;}
  more = new cljs.core.IndexedSeq(G__25891__a,0,null);
} 
return G__25890__delegate.call(this,x,y,more);};
...
var y = cljs.core.first(arglist__25892);
var more = cljs.core.rest(arglist__25892);
return G__25890__delegate(x,y,more);
});
...
G__25899 = new cljs.core.IndexedSeq(G__25900__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__25899);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25786__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__25787 = u(y);
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25787__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((op.cljs$core$IFn$_invoke$arity$2 ? op.cljs$core$IFn$_invoke$arity$2(m1,m2) : op.call(null,m1,m2)));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_divider_$_ud__3 = (function() { 
var G__25910__delegate = function (x,y,more){
...
var G__25910 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__25912__i = 0, G__25912__a = new Array(arguments.length -  2);
while (G__25912__i < G__25912__a.length) {G__25912__a[G__25912__i] = arguments[G__25912__i + 2]; ++G__25912__i;}
  more = new cljs.core.IndexedSeq(G__25912__a,0,null);
} 
return G__25910__delegate.call(this,x,y,more);};
G__25910.cljs$lang$maxFixedArity = 2;
...
return G__25910__delegate(x,y,more);
});
...
var G__25916 = null;
if (arguments.length > 2) {
var G__25917__i = 0, G__25917__a = new Array(arguments.length -  2);
while (G__25917__i < G__25917__a.length) {G__25917__a[G__25917__i] = arguments[G__25917__i + 2]; ++G__25917__i;}
G__25916 = new cljs.core.IndexedSeq(G__25917__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__25916);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
