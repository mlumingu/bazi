...
var G__29586 = (function (){var G__29587 = (rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1(node) : rewrite_clj.node.sexpr.call(null,node));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__29587) : f.call(null,G__29587));
})();
return (rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1(G__29586) : rewrite_clj.node.coerce.call(null,G__29586));
});
/**
...
var G__29610 = (i__4737__auto___29608 + (1));
i__4737__auto___29608 = G__29610;
continue;
} else {
}
break;
...
return clojure.zip.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.edit_node,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__29588_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__29588_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq29589){
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__29592 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__29592) : str_fn.call(null,G__29592));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__29594 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__29594) : str_fn.call(null,G__29594));
})()):null)));
...
var G__29600 = rewrite_clj.zip.base.tag(zloc);
var G__29600__$1 = (((G__29600 instanceof cljs.core.Keyword))?G__29600.fqn:null);
switch (G__29600__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__29598_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__29598_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__29599_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__29599_SHARP_)].join('');
}));
}
}));
...
var G__29606 = rewrite_clj.zip.base.tag(zloc);
var G__29606__$1 = (((G__29606 instanceof cljs.core.Keyword))?G__29606.fqn:null);
switch (G__29606__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__29604_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__29604_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__29606__$1)].join('')));
