...
var periods__$1 = cljs.core.vec((function (){var G__35412 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__35411_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__35411_SHARP_,(0),(3));
}),G__35412);
} else {
return G__35412;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__35423){
var vec__35424 = p__35423;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35424,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35424,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__35427 = pattern;
switch (G__35427) {
case "S":
...
return p1__35428_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__35429_SHARP_){
return p1__35429_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__35430_SHARP_){
return p1__35430_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__35431_SHARP_){
return p1__35431_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__35432_SHARP_){
return p1__35432_SHARP_.getHours();
});

break;
case "day":
return (function (p1__35433_SHARP_){
return p1__35433_SHARP_.getDate();
});

break;
case "month":
return (function (p1__35434_SHARP_){
return p1__35434_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__35435_SHARP_){
return p1__35435_SHARP_.getYear();
});
...
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__35437){
...
var key = first__35440;
var args = seq__35439__$1;
var G__35441 = key;
...
break;
case "ordinal-suffix":
var vec__35442 = (function (){var G__35445 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__35445) : syntax_list.call(null,G__35445));
})();
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35441__$1)].join('')));
...
var d = value;
var G__35449 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__35450 = G__35449;
...
var unparser = first__35452;
var more = seq__35451__$1;
var s = "";
var d__$1 = d;
var G__35449__$1 = G__35449;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__35459 = G__35449__$1;
...
var unparser__$1 = first__35461;
var more__$1 = seq__35460__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__35462 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35462,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35462,(1),null);
var G__35497 = d__$3;
var G__35498 = more__$1;
var G__35499 = s__$3;
d__$1 = G__35497;
G__35449__$1 = G__35498;
s__$1 = G__35499;
continue;
}
break;
