...
var len__4736__auto___49948 = arguments.length;
var i__4737__auto___49949 = (0);
while(true){
if((i__4737__auto___49949 < len__4736__auto___49948)){
args_arr__4757__auto__.push((arguments[i__4737__auto___49949]));

var G__49950 = (i__4737__auto___49949 + (1));
i__4737__auto___49949 = G__49950;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq49889){
...
var G__49893 = cljs.core.first(seq49889__$2);
var seq49889__$3 = cljs.core.next(seq49889__$2);
var G__49894 = cljs.core.first(seq49889__$3);
var seq49889__$4 = cljs.core.next(seq49889__$3);
var G__49895 = cljs.core.first(seq49889__$4);
var seq49889__$5 = cljs.core.next(seq49889__$4);
var G__49896 = cljs.core.first(seq49889__$5);
var seq49889__$6 = cljs.core.next(seq49889__$5);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49890,G__49891,G__49893,G__49894,G__49895,G__49896,seq49889__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__49930){
var vec__49931 = p__49930;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49931,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49931,(1),null);
