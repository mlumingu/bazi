...
var G__29653 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__29653__$1 = (((G__29653 == null))?null:cljs.core.iterate((function (loc){
...
var G__29653__$2 = (((G__29653__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__29653__$1));
var G__29653__$3 = (((G__29653__$2 == null))?null:cljs.core.last(G__29653__$2));
if((G__29653__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__29653__$3);
}
} else {
return zloc;
}
...
var G__29666 = rewrite_clj.zip.move.right(v);
var G__29667 = rewrite_clj.zip.move.up(v);
loc = G__29666;
parent = G__29667;
continue;
} else {
var G__29668 = rewrite_clj.zip.move.right(v0);
var G__29669 = parent;
loc = G__29668;
parent = G__29669;
continue;
...
var G__29670 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__29671 = rewrite_clj.zip.move.up(v);
loc = G__29670;
parent = G__29671;
continue;
} else {
var G__29672 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__29673 = parent;
loc = G__29672;
parent = G__29673;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__29664 = zloc;
var G__29664__$1 = (((G__29664 == null))?null:rewrite_clj.zip.move.down(G__29664));
var G__29664__$2 = (((G__29664__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__29664__$1,k));
if((G__29664__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__29664__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__29665 = rewrite_clj.zip.move.down(zloc);
var G__29665__$1 = (((G__29665 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__29665));
if((G__29665__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__29665__$1);
}
})(),k);
}
});
