...
var o46673 = temp__5733__auto__;
var temp__5733__auto____$1 = (o46673["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o46674 = temp__5733__auto____$1;
return (o46674["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__29254__auto__ = f;
return (o__29254__auto__["toString"]).call(o__29254__auto__);
} else {
return "";
}
}catch (e46689){var _ = e46689;
return "";
}});
...
try{var o__29254__auto___46875 = t;
(o__29254__auto___46875["cljs$lang$ctorPrWriter"]).call(o__29254__auto___46875,t,writer);
}catch (e46696){var __46876 = e46696;
}
...
var char_code = (function (){var o__29254__auto__ = (new String(char$));
return (o__29254__auto__["charCodeAt"]).call(o__29254__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__29254__auto__ = String;
return (o__29254__auto__["fromCharCode"]).call(o__29254__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__46699 = num_code;
switch (G__46699) {
case (1):
return (185);
...
var o__29254__auto__ = String;
return (o__29254__auto__["fromCharCode"]).call(o__29254__auto__,superscript_code);
});
/**
...
}catch (e46712){var _e__29315__auto__ = e46712;
return false;
}})())){
...
var vec__46713 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46713,(0),null);
...
var len__4736__auto___46899 = arguments.length;
var i__4737__auto___46900 = (0);
while(true){
if((i__4737__auto___46900 < len__4736__auto___46899)){
args__4742__auto__.push((arguments[i__4737__auto___46900]));

var G__46901 = (i__4737__auto___46900 + (1));
i__4737__auto___46900 = G__46901;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__46731){
var vec__46732 = p__46731;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46732,(0),null);
...
var G__46908 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__46909 = cljs.core.butlast(remaining_tokens);
name_tokens = G__46908;
remaining_tokens = G__46909;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq46729){
var G__46730 = cljs.core.first(seq46729);
var seq46729__$1 = cljs.core.next(seq46729);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46730,seq46729__$1);
}));
...
var vec__46741 = cljs.core.split_with((function (p1__46740_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__46740_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46741,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46741,(1),null);
...
var vec__46749 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46749,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46749,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__46922 = cljs.core.rest(remaining_tokens);
var G__46923 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__46922;
name_tokens = G__46923;
continue;
} else {
...
var vec__46756 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46756,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46756,(1),null);
var vec__46759 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46759,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46759,(1),null);
var vec__46762 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46762,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46762,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46762,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46762,(3),null);
...
var vec__46770 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46770,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46770,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46770,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46770,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46770,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46770,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__46773 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46773,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46773,(1),null);
var vec__46776 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46776,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46776,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__46782 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__46782) : devtools.munging.parse_fn_info_deep.call(null,G__46782));
})()));
}
} else {
return fn_info;
...
var G__46969 = (arity + (1));
var G__46970 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__46787){
var vec__46788 = p__46787;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46788,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46788,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46791_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__46791_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46792_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__46792_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__46796){
var vec__46797 = p__46796;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46797,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq46793){
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46820__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46820__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46820__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46820__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__46821 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46821,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46821,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46821,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46821,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46821,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46821,(5),null);
...
var o__29254__auto__ = f;
return (o__29254__auto__["getBasis"]).call(o__29254__auto__);
});
/**
...
}catch (e46829){var _e__29315__auto__ = e46829;
...
var G__46998 = (obj[cljs.core.first(path)]);
var G__46999 = cljs.core.rest(path);
obj = G__46998;
path = G__46999;
continue;
} else {
...
var _STAR_ = (function (accum,p__46849){
var vec__46850 = p__46849;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46850,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46850,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__46859){
var vec__46860 = p__46859;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46860,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46860,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46860,(2),null);
...
var post_process = (function (p__46867){
var vec__46868 = p__46867;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46868,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46868,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46866_SHARP_){
return (obj[cljs.core.first(p1__46866_SHARP_)]);
}),sorted_matches);
