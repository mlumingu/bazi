...
var G__55797 = o;
goog.object.set(G__55797,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__55841__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__55841 = function (var_args){
var args = null;
...
while (G__55845__i < G__55845__a.length) {G__55845__a[G__55845__i] = arguments[G__55845__i + 0]; ++G__55845__i;}
  args = new cljs.core.IndexedSeq(G__55845__a,0,null);
} 
return G__55841__delegate.call(this,args);};
G__55841.cljs$lang$maxFixedArity = 0;
G__55841.cljs$lang$applyTo = (function (arglist__55846){
var args = cljs.core.seq(arglist__55846);
return G__55841__delegate(args);
});
...
var G__55798 = o;
goog.object.set(G__55798,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__55854__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__55854 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__55855__i = 0, G__55855__a = new Array(arguments.length -  0);
while (G__55855__i < G__55855__a.length) {G__55855__a[G__55855__i] = arguments[G__55855__i + 0]; ++G__55855__i;}
  args = new cljs.core.IndexedSeq(G__55855__a,0,null);
} 
return G__55854__delegate.call(this,args);};
G__55854.cljs$lang$maxFixedArity = 0;
G__55854.cljs$lang$applyTo = (function (arglist__55856){
var args = cljs.core.seq(arglist__55856);
return G__55854__delegate(args);
});
G__55854.cljs$core$IFn$_invoke$arity$variadic = G__55854__delegate;
return G__55854;
})()
;
} else {
...
var G__55799 = props;
var G__55799__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__55799,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__55799);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__55799__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__55800 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__55800,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__55800;
}
})(),id_class);
...
var G__55801 = (cljs.core.count(argv) - first_child);
switch (G__55801) {
case (0):
...
var vec__55802 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55802,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55802,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55802,(2),null);
...
var temp__5739__auto___55880 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___55880 == null)){
} else {
var key_55884 = temp__5739__auto___55880;
(jsprops.key = key_55884);
}
...
var temp__5739__auto___55885 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___55885 == null)){
} else {
var key_55886 = temp__5739__auto___55885;
(jsprops.key = key_55886);
}
...
var temp__5739__auto___55889 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___55889 == null)){
} else {
var key_55890 = temp__5739__auto___55889;
(jsprops.key = key_55890);
}
...
var temp__5739__auto___55892 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___55892 == null)){
} else {
var key_55893 = temp__5739__auto___55892;
(jsprops.key = key_55893);
}
...
var temp__5739__auto___55903 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___55903 == null)){
} else {
var key_55904 = temp__5739__auto___55903;
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__55811_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__55811_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__55812 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55812,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55812,(1),null);
...
break;
default:
var G__55926 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__55927 = compiler;
v = G__55926;
compiler = G__55927;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template55827 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template55827 = (function (opts,id,fn_to_element,meta55828){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template55827.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_55829,meta55828__$1){
var self__ = this;
var _55829__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template55827(self__.opts,self__.id,self__.fn_to_element,meta55828__$1));
}));

(reagent.impl.template.t_reagent$impl$template55827.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_55829){
var self__ = this;
var _55829__$1 = this;
return self__.meta55828;
}));

(reagent.impl.template.t_reagent$impl$template55827.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template55827.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template55827.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template55827.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template55827.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta55828","meta55828",-1217378486,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template55827.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template55827.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template55827");

(reagent.impl.template.t_reagent$impl$template55827.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template55827");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template55827.
 */
reagent.impl.template.__GT_t_reagent$impl$template55827 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template55827(opts__$1,id__$1,fn_to_element__$1,meta55828){
return (new reagent.impl.template.t_reagent$impl$template55827(opts__$1,id__$1,fn_to_element__$1,meta55828));
});

}

return (new reagent.impl.template.t_reagent$impl$template55827(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
