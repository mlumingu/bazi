...
return [(function (){var pred__27284 = cljs.core.instance_QMARK_;
var expr__27285 = reactive_val;
if(cljs.core.truth_((pred__27284.cljs$core$IFn$_invoke$arity$2 ? pred__27284.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__27285) : pred__27284.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__27285)))){
return "ra";
} else {
if(cljs.core.truth_((pred__27284.cljs$core$IFn$_invoke$arity$2 ? pred__27284.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__27285) : pred__27284.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__27285)))){
return "rc";
} else {
if(cljs.core.truth_((pred__27284.cljs$core$IFn$_invoke$arity$2 ? pred__27284.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__27285) : pred__27284.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__27285)))){
return "rx";
} else {
if(cljs.core.truth_((pred__27284.cljs$core$IFn$_invoke$arity$2 ? pred__27284.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__27285) : pred__27284.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__27285)))){
return "tr";
} else {
return "other";
}
