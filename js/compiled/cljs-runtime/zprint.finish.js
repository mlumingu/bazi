...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__28732_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__28732_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__28732_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__28733){
var vec__28734 = p__28733;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28734,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28734,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__28750,s,color,element,idx){
var map__28754 = p__28750;
var map__28754__$1 = (((((!((map__28754 == null))))?(((((map__28754.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28754.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__28754):map__28754);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28754__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28754__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28754__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__28781 = (function (){var or__4126__auto__ = color;
...
var fexpr__28780 = (function (){var G__28783 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__28783) : style_map.call(null,G__28783));
})();
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__28796){
var vec__28797 = p__28796;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28797,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28797,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28797,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__28800){
var vec__28801 = p__28800;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28801,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28801,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28801,(2),null);
...
var G__28952 = cljs.core.next(ssv);
var G__28953 = (this_ssv == null);
var G__28954 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__28955 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__28952;
doing_nil_QMARK_ = G__28953;
last_elide = G__28954;
out = G__28955;
continue;
}
...
var vec__28836 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28836,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28836,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28836,(2),null);
...
var G__28956 = cljs.core.next(remaining_cvec);
var G__28957 = new_idx;
var G__28958 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__28956;
idx = G__28957;
out = G__28958;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__28857,cursor_vec){
var vec__28858 = p__28857;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28858,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28858,(1),null);
var focus_vec = vec__28858;
...
var vec__28861 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28861,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28861,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__28865){
var vec__28866 = p__28865;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28866,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28866,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__28876,existing_count){
var vec__28877 = p__28876;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28877,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28877,(1),null);
...
return cljs.core.filterv((function (p1__28870_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__28870_SHARP_))));
...
var vec__28886 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28886,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28886,(1),null);
var cvec_element = vec__28886;
if((cvec_element == null)){
var G__28980 = cljs.core.next(cvec_nl);
var G__28981 = (idx + (1));
var G__28982 = start;
var G__28983 = out;
cvec_nl = G__28980;
...
var G__28987 = cljs.core.next(cvec_nl);
var G__28988 = (idx + (1));
var G__28989 = idx;
var G__28990 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__28987;
idx = G__28988;
start = G__28989;
out = G__28990;
...
var G__28991 = cljs.core.next(cvec_nl);
var G__28992 = (idx + (1));
var G__28993 = (idx + (1));
var G__28994 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__28991;
idx = G__28992;
start = G__28993;
out = G__28994;
...
var G__28995 = cljs.core.next(cvec_nl);
var G__28996 = (idx + (1));
var G__28997 = idx;
var G__28998 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__28995;
idx = G__28996;
start = G__28997;
out = G__28998;
...
var G__28999 = cljs.core.next(cvec_nl);
var G__29000 = (idx + (1));
var G__29001 = start;
var G__29002 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__28999;
idx = G__29000;
start = G__29001;
out = G__29002;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__28900_SHARP_,p2__28899_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__28899_SHARP_)){
return cljs.core.reduced(p1__28900_SHARP_);
} else {
return (p1__28900_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__28910,p__28911){
var vec__28914 = p__28910;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28914,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28914,(1),null);
var vec__28917 = p__28911;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28917,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28917,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__28928,cvec,focus_vec){
...
var options = map__28929__$1;
var map__28930 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28929__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28930__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28930__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28930__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28925_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__28925_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
