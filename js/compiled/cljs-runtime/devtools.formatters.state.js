...
var len__4736__auto___46726 = arguments.length;
var i__4737__auto___46727 = (0);
while(true){
if((i__4737__auto___46727 < len__4736__auto___46726)){
args__4742__auto__.push((arguments[i__4737__auto___46727]));

var G__46728 = (i__4737__auto___46727 + (1));
i__4737__auto___46727 = G__46728;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq46700){
var G__46701 = cljs.core.first(seq46700);
var seq46700__$1 = cljs.core.next(seq46700);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46701,seq46700__$1);
}));
...
return cljs.core.some((function (p1__46709_SHARP_){
return (p1__46709_SHARP_ === object);
}),history);
});
