...
try{var G__28050_28219 = (function (p1__28037_SHARP_){
return promesa.protocols._resolve_BANG_(d,p1__28037_SHARP_);
});
var G__28051_28220 = (function (p1__28042_SHARP_){
return promesa.protocols._reject_BANG_(d,p1__28042_SHARP_);
});
(f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__28050_28219,G__28051_28220) : f.call(null,G__28050_28219,G__28051_28220));
}catch (e28049){var e_28221 = e28049;
promesa.protocols._reject_BANG_(d,e_28221);
}
return d;
}));
...
try{var G__28054 = (function (p1__28043_SHARP_){
return promesa.protocols._resolve_BANG_(d,p1__28043_SHARP_);
});
var G__28055 = (function (p1__28044_SHARP_){
return promesa.protocols._reject_BANG_(d,p1__28044_SHARP_);
});
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__28054,G__28055) : f.call(null,G__28054,G__28055));
}catch (e28053){var e = e28053;
...
args_arr__4757__auto__.push((arguments[i__4737__auto___28229]));
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__28089_SHARP_,p2__28090_SHARP_){
return promesa.core.then.cljs$core$IFn$_invoke$arity$2(p1__28089_SHARP_,p2__28090_SHARP_);
}),p,cljs.core.cons(f,fs));
}));

/** @this {Function} */
(promesa.core.chain.cljs$lang$applyTo = (function (seq28092){
...
default:
var args_arr__4757__auto__ = [];
var len__4736__auto___28232 = arguments.length;
var i__4737__auto___28233 = (0);
while(true){
if((i__4737__auto___28233 < len__4736__auto___28232)){
args_arr__4757__auto__.push((arguments[i__4737__auto___28233]));

var G__28234 = (i__4737__auto___28233 + (1));
i__4737__auto___28233 = G__28234;
continue;
} else {
}
break;
...
/** @this {Function} */
(promesa.core.chain_SINGLEQUOTE_.cljs$lang$applyTo = (function (seq28097){
...
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28098,G__28099,seq28097__$2);
}));
...
var accept_QMARK_ = ((cljs.core.ifn_QMARK_(pred_or_type))?pred_or_type:(function (p1__28105_SHARP_){
return (p1__28105_SHARP_ instanceof pred_or_type);
}));
...
var accept_QMARK_ = ((cljs.core.ifn_QMARK_(pred_or_type))?pred_or_type:(function (p1__28108_SHARP_){
return (p1__28108_SHARP_ instanceof pred_or_type);
}));
...
var seq__28115 = cljs.core.seq(promises);
var chunk__28116 = null;
var count__28117 = (0);
var i__28118 = (0);
while(true){
if((i__28118 < count__28117)){
var p = chunk__28116.cljs$core$IIndexed$_nth$arity$2(null,i__28118);
promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(promesa.core.then.cljs$core$IFn$_invoke$arity$2(promesa.core.promise.cljs$core$IFn$_invoke$arity$1(p),((function (seq__28115,chunk__28116,count__28117,i__28118,p,state){
return (function (v){
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (seq__28115,chunk__28116,count__28117,i__28118,p,state){
...
});})(seq__28115,chunk__28116,count__28117,i__28118,p,state))
);

return (resolve.cljs$core$IFn$_invoke$arity$1 ? resolve.cljs$core$IFn$_invoke$arity$1(v) : resolve.call(null,v));
}
});})(seq__28115,chunk__28116,count__28117,i__28118,p,state))
),((function (seq__28115,chunk__28116,count__28117,i__28118,p,state){
return (function (e){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (seq__28115,chunk__28116,count__28117,i__28118,p,state){
return (function (state__$1){
...
var map__28134 = cljs.core.deref(state);
var map__28134__$1 = (((((!((map__28134 == null))))?(((((map__28134.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28134.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__28134):map__28134);
var resolved = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28134__$1,new cljs.core.Keyword(null,"resolved","resolved",968763567));
var counter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28134__$1,new cljs.core.Keyword(null,"counter","counter",804008177));
var rejections = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28134__$1,new cljs.core.Keyword(null,"rejections","rejections",-1620899911));
...
var G__28137 = cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2("No promises resolved",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"rejections","rejections",-1620899911),rejections], null));
return (reject.cljs$core$IFn$_invoke$arity$1 ? reject.cljs$core$IFn$_invoke$arity$1(G__28137) : reject.call(null,G__28137));
} else {
...
var G__28250 = seq__28115;
var G__28251 = chunk__28116;
var G__28252 = count__28117;
var G__28253 = (i__28118 + (1));
seq__28115 = G__28250;
chunk__28116 = G__28251;
count__28117 = G__28252;
i__28118 = G__28253;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__28115);
if(temp__5735__auto__){
var seq__28115__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__28115__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__28115__$1);
var G__28255 = cljs.core.chunk_rest(seq__28115__$1);
var G__28256 = c__4556__auto__;
var G__28257 = cljs.core.count(c__4556__auto__);
var G__28258 = (0);
seq__28115 = G__28255;
chunk__28116 = G__28256;
count__28117 = G__28257;
i__28118 = G__28258;
continue;
} else {
var p = cljs.core.first(seq__28115__$1);
promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(promesa.core.then.cljs$core$IFn$_invoke$arity$2(promesa.core.promise.cljs$core$IFn$_invoke$arity$1(p),((function (seq__28115,chunk__28116,count__28117,i__28118,p,seq__28115__$1,temp__5735__auto__,state){
return (function (v){
if(cljs.core.truth_(new cljs.core.Keyword(null,"resolved","resolved",968763567).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)))){
return null;
} else {
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (seq__28115,chunk__28116,count__28117,i__28118,p,seq__28115__$1,temp__5735__auto__,state){
return (function (state__$1){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(state__$1,new cljs.core.Keyword(null,"resolved","resolved",968763567),true),new cljs.core.Keyword(null,"counter","counter",804008177),cljs.core.dec);
});})(seq__28115,chunk__28116,count__28117,i__28118,p,seq__28115__$1,temp__5735__auto__,state))
);

return (resolve.cljs$core$IFn$_invoke$arity$1 ? resolve.cljs$core$IFn$_invoke$arity$1(v) : resolve.call(null,v));
}
});})(seq__28115,chunk__28116,count__28117,i__28118,p,seq__28115__$1,temp__5735__auto__,state))
),((function (seq__28115,chunk__28116,count__28117,i__28118,p,seq__28115__$1,temp__5735__auto__,state){
return (function (e){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (seq__28115,chunk__28116,count__28117,i__28118,p,seq__28115__$1,temp__5735__auto__,state){
return (function (state__$1){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(cljs.core.update.cljs$core$IFn$_invoke$arity$3(state__$1,new cljs.core.Keyword(null,"counter","counter",804008177),cljs.core.dec),new cljs.core.Keyword(null,"rejections","rejections",-1620899911),cljs.core.conj,e);
...
var map__28145 = cljs.core.deref(state);
...
var resolved = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28145__$1,new cljs.core.Keyword(null,"resolved","resolved",968763567));
var counter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28145__$1,new cljs.core.Keyword(null,"counter","counter",804008177));
var rejections = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28145__$1,new cljs.core.Keyword(null,"rejections","rejections",-1620899911));
if(((cljs.core.not(resolved)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(counter,(0))))){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(default$,new cljs.core.Keyword("promesa.core","default","promesa.core/default",1773193826))){
var G__28147 = cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2("No promises resolved",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"rejections","rejections",-1620899911),rejections], null));
return (reject.cljs$core$IFn$_invoke$arity$1 ? reject.cljs$core$IFn$_invoke$arity$1(G__28147) : reject.call(null,G__28147));
} else {
return (resolve.cljs$core$IFn$_invoke$arity$1 ? resolve.cljs$core$IFn$_invoke$arity$1(default$) : resolve.call(null,default$));
}
} else {
...
var G__28270 = cljs.core.next(seq__28115__$1);
var G__28271 = null;
var G__28272 = (0);
var G__28273 = (0);
seq__28115 = G__28270;
chunk__28116 = G__28271;
count__28117 = G__28272;
i__28118 = G__28273;
continue;
}
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__28152_SHARP_,p2__28153_SHARP_){
return promesa.core.then.cljs$core$IFn$_invoke$arity$2(p1__28152_SHARP_,(function (_){
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(p2__28153_SHARP_) : f.call(null,p2__28153_SHARP_));
}));
...
}catch (e28164){if((e28164 instanceof Error)){
var e = e28164;
...
G__28276.cljs$lang$applyTo = (function (arglist__28279){
var args = cljs.core.seq(arglist__28279);
