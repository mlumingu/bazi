...
var G__31087 = request;
var G__31088 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__31087,G__31088) : ajax.formats.get_format.call(null,G__31087,G__31088));
} else {
...
return cljs.core.some((function (p1__31092_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__31092_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__31098){
...
var request = map__31099__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31099__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__31102 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__31102.cljs$core$IFn$_invoke$arity$1 ? fexpr__31102.cljs$core$IFn$_invoke$arity$1(response) : fexpr__31102.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__31104){
...
var request = map__31106__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31106__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__31103_SHARP_){
return ajax.formats.get_accept_entries(request,p1__31103_SHARP_);
