...
var G__25383 = devtools.prefs.pref(v);
v = G__25383;
continue;
} else {
return v;
...
}catch (e25328){var _e__24799__auto__ = e25328;
return false;
}})();
...
}catch (e25334){var _e__24799__auto__ = e25334;
return false;
}})();
...
}catch (e25337){var _e__24799__auto__ = e25337;
return false;
}}
}
});
...
var vec__25357 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25357,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25357,(1),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__25365_SHARP_);
}),template);
});
