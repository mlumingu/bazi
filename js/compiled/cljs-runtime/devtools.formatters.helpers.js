...
var G__46931 = devtools.prefs.pref(v);
v = G__46931;
continue;
} else {
return v;
...
}catch (e46880){var _e__29315__auto__ = e46880;
return false;
}})();
...
}catch (e46884){var _e__29315__auto__ = e46884;
return false;
}})();
...
}catch (e46886){var _e__29315__auto__ = e46886;
return false;
}}
}
});
...
var vec__46905 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46905,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46905,(1),null);
...
return cljs.core.some((function (p1__46914_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__46914_SHARP_);
}),template);
});
