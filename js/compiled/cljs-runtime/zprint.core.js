...
var vec__31541 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__31544 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31544,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31544,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31541,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31541,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__31547){
var vec__31548 = p__31547;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31548,(0),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31554,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31554,(1),null);
...
var vec__31566 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31566,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31566,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31566,(2),null);
var vec__31569 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31569,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31569,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31569,(2),null);
...
var G__31575 = special_option;
var G__31575__$1 = (((G__31575 instanceof cljs.core.Keyword))?G__31575.fqn:null);
switch (G__31575__$1) {
case "explain":
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__31576){
...
var vec__31580 = tuple;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31580,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31580,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31580,(2),null);
...
var vec__31592 = cljs.core.first(style_vec);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31592,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31592,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31592,(2),null);
var tuple = vec__31592;
...
var G__31662 = cljs.core.next(style_vec);
var G__31663 = ends_w_blanks_QMARK_;
var G__31664 = tuple;
var G__31665 = (cljs.core.truth_(add_previous_to_out_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,previous_tuple):out);
style_vec = G__31662;
previous_ends_w_blanks_QMARK_ = G__31663;
previous_tuple = G__31664;
out = G__31665;
continue;
}
break;
...
var G__31670 = (i__4737__auto___31668 + (1));
i__4737__auto___31668 = G__31670;
continue;
} else {
}
break;
...
var vec__31598 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31598,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31598,(1),null);
...
var result = (function (){var G__31601 = zprint.core.parse_string_all_options(rest_options);
var G__31602 = zprint.core.zprint_str_internal;
var G__31603 = ":parse-string-all? call";
var G__31604 = (function (){var G__31605 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__31605) : zprint.zutil.edn_STAR_.call(null,G__31605));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__31601,G__31602,G__31603,G__31604) : zprint.core.process_multiple_forms.call(null,G__31601,G__31602,G__31603,G__31604));
})();
if(cljs.core.truth_(new cljs.core.Keyword(null,"dbg?","dbg?",1845730771).cljs$core$IFn$_invoke$arity$1(rest_options))){
...
var vec__31606 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31606,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31606,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq31595){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31596,G__31597,seq31595__$2);
}));
...
while(true){
if((i__4737__auto___31685 < len__4736__auto___31683)){
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq31611){
var G__31612 = cljs.core.first(seq31611);
var seq31611__$1 = cljs.core.next(seq31611);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31612,seq31611__$1);
}));
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq31613){
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq31615){
var G__31616 = cljs.core.first(seq31615);
var seq31615__$1 = cljs.core.next(seq31615);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31616,seq31615__$1);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___31704 = arguments.length;
var i__4737__auto___31705 = (0);
while(true){
if((i__4737__auto___31705 < len__4736__auto___31704)){
args__4742__auto__.push((arguments[i__4737__auto___31705]));

var G__31706 = (i__4737__auto___31705 + (1));
i__4737__auto___31705 = G__31706;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq31617){
var G__31618 = cljs.core.first(seq31617);
var seq31617__$1 = cljs.core.next(seq31617);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31618,seq31617__$1);
}));
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__31620,form){
var vec__31621 = p__31620;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31621,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31621,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31621,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31621,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__31624 = (cljs.core.truth_((function (){var and__4115__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4115__auto__)){
if((indent === (0))){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31624,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31624,(1),null);
...
var G__31722 = cljs.core.next(sos);
var G__31723 = comment_QMARK_;
var G__31724 = (function (){var or__4126__auto__ = (!(empty_string_QMARK_));
if(or__4126__auto__){
return or__4126__auto__;
} else {
...
var G__31725 = ((empty_string_QMARK_)?out:((cljs.core.not(start_interpolating_QMARK_))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,s):(cljs.core.truth_(previous_comment_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,"\n"),s):cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,interpose_str),s)
)));
sos = G__31722;
previous_comment_QMARK_ = G__31723;
start_interpolating_QMARK_ = G__31724;
out = G__31725;
continue;
}
break;
...
try{var vec__31630 = zprint.core.remove_shebang(file_str);
var shebang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31630,(0),null);
var file_str__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31630,(1),null);
...
var vec__31633 = (cljs.core.truth_((function (){var or__4126__auto__ = range_start__$1;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return range_end__$1;
...
var actual_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31633,(0),null);
var actual_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31633,(1),null);
...
var vec__31636 = (cljs.core.truth_((function (){var and__4115__auto__ = actual_start;
if(cljs.core.truth_(and__4115__auto__)){
return actual_end;
} else {
return and__4115__auto__;
...
var before_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31636,(0),null);
var range = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31636,(1),null);
var after_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31636,(2),null);
...
var forms = (function (){var G__31641 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__31641) : zprint.zutil.edn_STAR_.call(null,G__31641));
})();
