...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_30854 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_30854(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_30855 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_30855(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_30856 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_30856(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_30857 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_30857(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_30858 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_30858(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_30859 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_30859(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_30860 = (function (this$,header){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_30860(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_30865 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_30865(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_30867 = (function (this$,request){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_30867(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_30868 = (function (this$,response){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_30868(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k30841,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k30841,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__30846){
var vec__30847 = p__30846;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30847,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30847,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__30840){
var self__ = this;
var G__30840__$1 = this;
return (new cljs.core.RecordIter((0),G__30840__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this30842,other30843){
var self__ = this;
var this30842__$1 = this;
return (((!((other30843 == null)))) && ((this30842__$1.constructor === other30843.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this30842__$1.status,other30843.status)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this30842__$1.body,other30843.body)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this30842__$1.status_text,other30843.status_text)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this30842__$1.headers,other30843.headers)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this30842__$1.was_aborted,other30843.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this30842__$1.__extmap,other30843.__extmap)));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__30840){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__30850 = cljs.core.keyword_identical_QMARK_;
var expr__30851 = k__4388__auto__;
if(cljs.core.truth_((pred__30850.cljs$core$IFn$_invoke$arity$2 ? pred__30850.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__30851) : pred__30850.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__30851)))){
return (new ajax.protocols.Response(G__30840,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__30850.cljs$core$IFn$_invoke$arity$2 ? pred__30850.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__30851) : pred__30850.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__30851)))){
return (new ajax.protocols.Response(self__.status,G__30840,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__30850.cljs$core$IFn$_invoke$arity$2 ? pred__30850.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__30851) : pred__30850.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__30851)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__30840,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__30850.cljs$core$IFn$_invoke$arity$2 ? pred__30850.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__30851) : pred__30850.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__30851)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__30840,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__30850.cljs$core$IFn$_invoke$arity$2 ? pred__30850.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__30851) : pred__30850.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__30851)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__30840,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__30840),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__30840){
var self__ = this;
var this__4379__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__30840,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__30844){
var extmap__4419__auto__ = (function (){var G__30853 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__30844,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__30844)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__30853);
} else {
return G__30853;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__30844),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__30844),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__30844),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__30844),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__30844),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
