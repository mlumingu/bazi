...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k28977,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k28977,else__4383__auto__);
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__28976){
var self__ = this;
var G__28976__$1 = this;
return (new cljs.core.RecordIter((0),G__28976__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"s","s",1705939918)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this28978,other28979){
var self__ = this;
var this28978__$1 = this;
return (((!((other28979 == null)))) && ((this28978__$1.constructor === other28979.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this28978__$1.s,other28979.s)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this28978__$1.__extmap,other28979.__extmap)));
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__28976){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__29023 = cljs.core.keyword_identical_QMARK_;
var expr__29024 = k__4388__auto__;
if(cljs.core.truth_((pred__29023.cljs$core$IFn$_invoke$arity$2 ? pred__29023.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"s","s",1705939918),expr__29024) : pred__29023.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__29024)))){
return (new rewrite_clj.node.comment.CommentNode(G__28976,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.comment.CommentNode(self__.s,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__28976),null));
}
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__28976){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.comment.CommentNode(self__.s,G__28976,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.comment.map__GT_CommentNode = (function rewrite_clj$node$comment$map__GT_CommentNode(G__28986){
var extmap__4419__auto__ = (function (){var G__29028 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__28986,new cljs.core.Keyword(null,"s","s",1705939918));
...
return (new rewrite_clj.node.comment.CommentNode(new cljs.core.Keyword(null,"s","s",1705939918).cljs$core$IFn$_invoke$arity$1(G__28986),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
