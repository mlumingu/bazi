...
return [(function (){var pred__55984 = cljs.core.instance_QMARK_;
var expr__55985 = reactive_val;
if(cljs.core.truth_((pred__55984.cljs$core$IFn$_invoke$arity$2 ? pred__55984.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__55985) : pred__55984.call(null,reagent.ratom.RAtom,expr__55985)))){
return "ra";
} else {
if(cljs.core.truth_((pred__55984.cljs$core$IFn$_invoke$arity$2 ? pred__55984.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__55985) : pred__55984.call(null,reagent.ratom.RCursor,expr__55985)))){
return "rc";
} else {
if(cljs.core.truth_((pred__55984.cljs$core$IFn$_invoke$arity$2 ? pred__55984.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__55985) : pred__55984.call(null,reagent.ratom.Reaction,expr__55985)))){
return "rx";
} else {
if(cljs.core.truth_((pred__55984.cljs$core$IFn$_invoke$arity$2 ? pred__55984.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__55985) : pred__55984.call(null,reagent.ratom.Track,expr__55985)))){
return "tr";
} else {
return "other";
}
