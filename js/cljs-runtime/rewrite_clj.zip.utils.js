...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__29483,k,f){
var vec__29484 = p__29483;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29484,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29484,(1),null);
var loc = vec__29484;
...
var G__29527 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__29527;
continue;
}
break;
...
var G__29529 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__29529;
continue;
} else {
return zloc__$1;
...
var G__29531 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__29531;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__29494){
var vec__29496 = p__29494;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29496,(0),null);
var map__29499 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29496,(1),null);
...
var path = map__29499__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29499__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__29496;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__29504){
var vec__29505 = p__29504;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29505,(0),null);
var map__29508 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29505,(1),null);
...
var path = map__29508__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29508__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__29505;
if(cljs.core.seq(r)){
...
var vec__29512 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29512,(0),null);
var map__29515 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29512,(1),null);
...
var path = map__29515__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29515__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29515__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29515__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29515__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
