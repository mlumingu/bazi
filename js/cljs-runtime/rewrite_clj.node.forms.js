...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k28973,else__4383__auto__){
var self__ = this;
...
var vec__29010 = p__29006;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29010,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29010,(1),null);
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__28972){
var self__ = this;
var G__28972__$1 = this;
return (new cljs.core.RecordIter((0),G__28972__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this28974,other28975){
var self__ = this;
var this28974__$1 = this;
return (((!((other28975 == null)))) && ((this28974__$1.constructor === other28975.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this28974__$1.children,other28975.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this28974__$1.__extmap,other28975.__extmap)));
}));
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__28972){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__29032 = cljs.core.keyword_identical_QMARK_;
var expr__29033 = k__4388__auto__;
if(cljs.core.truth_((pred__29032.cljs$core$IFn$_invoke$arity$2 ? pred__29032.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__29033) : pred__29032.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__29033)))){
return (new rewrite_clj.node.forms.FormsNode(G__28972,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.forms.FormsNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__28972),null));
}
}));
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__28972){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.forms.FormsNode(self__.children,G__28972,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.forms.map__GT_FormsNode = (function rewrite_clj$node$forms$map__GT_FormsNode(G__28984){
var extmap__4419__auto__ = (function (){var G__29038 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__28984,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__28984)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__29038);
} else {
return G__29038;
}
})();
return (new rewrite_clj.node.forms.FormsNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__28984),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
