...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_49362 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_49362(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_49365 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_49365(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_49378 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_49378(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_49387 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_49387(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_49400 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_49400(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_49404 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_49404(reader);
}
});
...
var G__49526 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__49527 = s.append(c);
c = G__49526;
s = G__49527;
continue;
}
